...
const MORNING = [{name: "Now", subpages: [{name: "current-page", duration: 13000}, {name: "radar-page", duration: 11000}]},{name: "Today", subpages: [{name: "today-page", duration: 13000}]},{name: "Tonight", subpages: [{name: "tonight-page", duration: 13000}]},{name: "Beyond", subpages: [{name: "tomorrow-page", duration: 13000}, {name: "7day-page", duration: 13000}]},]
const NIGHT = [{name: "Now", subpages: [{name: "current-page", duration: 13000}, {name: "radar-page", duration: 11000}]},{name: "Tonight", subpages: [{name: "tonight-page", duration: 13000}]},{name: "Beyond", subpages: [{name: "tomorrow-page", duration: 13000}, {name: "tomorrow-night-page", duration: 13000}, {name: "7day-page", duration: 13000}]},]
const SINGLE = [{name: "Alert", subpages: [{name: "single-alert-page", duration: 10000}]},{name: "Now", subpages: [{name: "current-page", duration: 11000}, {name: "radar-page", duration: 11000}, {name: "zoomed-radar-page", duration: 11000}]},{name: "Tonight", subpages: [{name: "tonight-page", duration: 11000}]},{name: "Beyond", subpages: [{name: "tomorrow-page", duration: 11000}, {name: "7day-page", duration: 16000}]},]
...
window.onload = function () {
  ...
  CONFIG.addLocationOption('airport-code', 'Airport', 'SBN or KSBN')
...
function executeGreetingPage(){
  ...
  setTimeout(clearGreetingPage, 5000);
}
